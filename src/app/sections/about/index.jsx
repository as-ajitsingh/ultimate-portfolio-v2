const AboutMe = () => {
  return (
    <section id="about" className="h-dvh content-center flex relative">
      <div id="background-rectangle" className="absolute top-[-10rem] inset-0 flex justify-center z-[-1]">
      ...
      <div className="relative z-10 mt-35 flex flex-col items-center gap-10 sm:gap-20">
        ...
        <p className="text-primary-100 text-body-01-normal text-center">
          I’m into learning new tech, building cool tools, and pretending I have it all figured out in blog form. And
          yeah, that chatbot you see below? I built it (mostly to show off). Go ahead and interact with it—but please be
          nice, it’s still learning.
        </p>
