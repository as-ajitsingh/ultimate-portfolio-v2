import {SiNestjs, SiTypescript, SiExpress, SiJest, SiVitest, SiRedis, SiAmazondynamodb, SiApachekafka, SiDatadog, SiMetabase, SiKubernetes, SiGithubactions} from 'react-icons/si';
import {FaNodeJs, FaReact, FaCss3, FaHtml5, FaFigma, FaAws, FaDocker, FaGitAlt, FaGithub, FaGitlab} from'react-icons/fa';
...
export default [
    ...
    { title: "Microservices", icon: <MdMiscellaneousServices />, description: "", categories:[CATEGORIES.BACKEND, CATEGORIES.CLOUD_INFRA] },
    ...
    { title: "Jest", icon: <SiJest />, description: "", categories:[CATEGORIES.BACKEND, CATEGORIES.FRONTEND,CATEGORIES.TESTING ] },
    { title: "Vitest", icon: <SiVitest />, description: "", categories:[CATEGORIES.BACKEND, CATEGORIES.FRONTEND,CATEGORIES.TESTING ] },
    { title: "Postgresql", icon: <BiLogoPostgresql />, description: "", categories:[CATEGORIES.BACKEND, CATEGORIES.DATABASE] },
    ...
    { title: "DynamoDB", icon: <SiAmazondynamodb />, description: "", categories:[CATEGORIES.BACKEND, CATEGORIES.DATABASE] },
    ...
    { title: "Metabase", icon: <SiMetabase />, description: "", categories:[CATEGORIES.MONITORING, CATEGORIES.DATABASE] },
